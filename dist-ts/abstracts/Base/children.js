...
exports.getChildren = exports.getComponentElements = void 0;
/**
...
function getChild(el, ComponentClass, parent) {
    ...
    if (ComponentClass.__isBase__) {
        ...
        Object.defineProperty(child, '$parent', { get: function () { return parent; } });
        return child;
    }
...
function getChildren(instance, element, components) {
    var children = Object.entries(components).reduce(function (acc, _a) {
        var name = _a[0], ComponentClass = _a[1];
        var elements = getComponentElements(name, element);
        if (elements.length === 0) {
            return acc;
        }
        acc[name] = elements
            .map(function (el) { return getChild(el, ComponentClass, instance); })
            // Filter out terminated children
            .filter(function (el) { return el !== 'terminated'; });
