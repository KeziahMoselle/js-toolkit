...
exports.setClassesOrStyles = void 0;
var nextFrame_1 = __importDefault(require("../nextFrame"));
var classes = __importStar(require("./classes"));
 ...
 * @return {Promise}
 */
function start(element, classesOrStyles) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, nextFrame_1.default()];
                case 1:
                    _a.sent();
 ...
 * @return {Promise}
 */
function next(element, classesOrStyles) {
    return __awaiter(this, void 0, void 0, function () {
        var hasTransition;
        var _this = this;
        return __generator(this, function (_a) {
 ...
 */
function transition(element, name, endMode) {
    if (endMode === void 0) { endMode = 'remove'; }
    return __awaiter(this, void 0, void 0, function () {
        var classesOrStyles;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    classesOrStyles = typeof name === 'string'
                        ...
                        : __assign({ from: '', active: '', to: '' }, name);
                    // End any previous transition running on the element.
                    if (element.__isTransitioning__) {
                        end(element, classesOrStyles);
                    }
                    return [4 /*yield*/, start(element, classesOrStyles)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, next(element, classesOrStyles)];
                case 2:
                    _a.sent();
